...
*  The Community Edition DockerHub repository can be found at [factorhouse/kpow-ee](https://hub.docker.com/r/kpow-se) 
...
* [90.1.3, latest](https://github.com/factorhouse/kpow-ce/blob/main/dockerfile/kpow/Dockerfile)
