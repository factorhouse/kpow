...
Dockerfile for the community edition of [Kpow](https://kpow.io) - The Ultimate Engineering Toolkit for [Apache Kafka®](https://kafka.apache.org/)
...
*  The Enterprise Edition DockerHub repository can be found at [factorhouse/kpow-ee](https://hub.docker.com/r/factorhouse/kpow-se) 
...
* [90.1.3, latest](https://github.com/factorhouse/kpow/blob/main/dockerfile/kpow-ce/Dockerfile)
